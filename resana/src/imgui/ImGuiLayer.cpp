...
ImGuiLayer::~ImGuiLayer() { RS_CORE_TRACE("ImGuiLayer destroyed"); }
...
void ImGuiLayer::OnAttach() {
  ...
  // windows can look identical to the style
...
void ImGuiLayer::OnImGuiRender() { ShowImGuiDockspace(); }
...
void ImGuiLayer::SetTaskManagerTheme() {
  ...
  auto &io = ImGui::GetIO();
  io.Fonts->AddFontFromFileTTF("assets\\fonts\\REFSAN.TTF", sizePixels,
                               &config);
  ...
  // 110/255.0f,110/255.0f,128/255.0f,128/255.0f };;
